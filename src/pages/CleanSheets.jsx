                                ...
                                {players.map((p, idx) => (
                                    ...
                                    >
                                        ...
                                        <div className="ml-8 flex-grow flex flex-col justify-center h-full">
                                            ...
                                            <p className="text-[10px] font-bold uppercase tracking-widest mt-1 text-emerald-400 leading-none">{teams.find(t => t.id === p.teamId)?.name}</p>
                                        </div>
                                        <div className="text-right pr-4 flex flex-col justify-center h-full min-w-[120px]">
                                            <span className="text-[10px] font-black uppercase tracking-widest block mb-1 text-emerald-400 opacity-80 leading-none">CS</span>
                                            <span className="text-5xl font-black italic tracking-tighter text-white leading-[1]">{p.cleanSheets}</span>
                                        </div>
                                    </div>
                                ))}
                            </div>
