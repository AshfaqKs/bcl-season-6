            ...
            <div className="container mx-auto px-4">
                <div className={`relative flex justify-between items-center px-6 h-20 rounded-[30px] transition-all duration-500 border border-white/5 shadow-2xl overflow-hidden ${scrolled ? 'bg-navy-dark/80 backdrop-blur-2xl' : 'bg-navy-light/40 backdrop-blur-lg'}`}>
                    ...
                    <Link to="/" className="flex items-center space-x-3 group relative z-10 shrink-0">
                        <div className="w-10 h-10 bg-primary rounded-xl flex items-center justify-center text-navy-dark text-xl font-black shadow-[0_0_20px_rgba(0,240,255,0.4)] group-hover:rotate-[360deg] transition-transform duration-700">⚽</div>
                        <span className="text-2xl font-black tracking-tighter italic text-white">
                            BCL <span className="text-primary italic font-black group-hover:text-white transition-colors">S6</span>
                        </span>
                    </Link>
